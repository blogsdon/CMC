...
provenanceFile="/shared/CMC/metanetworksV2/Full/ACC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Full/ACC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Full/ACC/MICorout.txt"

#job script name
jobname="CMCACCMICorFull"
