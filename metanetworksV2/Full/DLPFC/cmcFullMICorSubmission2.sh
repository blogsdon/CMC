...
provenanceFile="/shared/CMC/metanetworksV2/Full/DLPFC/provenanceFileMICor2.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Full/DLPFC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Full/DLPFC/MICorout.txt"

#job script name
jobname="CMCDLPFCMICorFull"
