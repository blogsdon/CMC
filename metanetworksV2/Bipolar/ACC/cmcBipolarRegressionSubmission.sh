...
outputpath="/shared/CMC/metanetworksV2/Bipolar/ACC/"
...
provenanceFile="/shared/CMC/metanetworksV2/Bipolar/ACC/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Bipolar/ACC/Regressionerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Bipolar/ACC/Regressionout.txt"

#job script name
jobname="CMCACCRegressionBipolar"
