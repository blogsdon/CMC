...
provenanceFile="/shared/CMC/metanetworksV2/Bipolar/ACC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Bipolar/ACC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Bipolar/ACC/MICorout.txt"

#job script name
jobname="CMCACCMICorBipolar"
