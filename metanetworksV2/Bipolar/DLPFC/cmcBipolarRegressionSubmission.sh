...
provenanceFile="/shared/CMC/metanetworksV2/Bipolar/DLPFC/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Bipolar/DLPFC/Regressionerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Bipolar/DLPFC/Regressionout.txt"

#job script name
jobname="CMCDLPFCRegressionBipolar"
