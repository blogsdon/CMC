...
outputpath="/local/CMC/metanetworksV2/Schizophrenia/ACC/"
...
provenanceFile="/shared/CMC/metanetworksV2/Schizophrenia/ACC/provenanceFile.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Schizophrenia/ACC/Aggregationerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Schizophrenia/ACC/Aggregationout.txt"

#job script name
jobname="CMCSchizophreniaAccaggregation"
