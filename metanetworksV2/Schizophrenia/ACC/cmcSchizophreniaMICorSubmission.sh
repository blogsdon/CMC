...
provenanceFile="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/MICorout.txt"

#job script name
jobname="CMCDLPFCMICorSchizophrenia"
