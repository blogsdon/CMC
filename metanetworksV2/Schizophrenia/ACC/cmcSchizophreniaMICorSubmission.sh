...
provenanceFile="/shared/CMC/metanetworksV2/Schizophrenia/ACC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Schizophrenia/ACC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Schizophrenia/ACC/MICorout.txt"

#job script name
jobname="CMCACCMICorSchizophrenia"
