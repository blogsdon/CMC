...
outputpath="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/"
...
provenanceFile="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/Regressionerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Schizophrenia/DLPFC/Regressionout.txt"

#job script name
jobname="CMCDLPFCRegressionSchizophrenia"
