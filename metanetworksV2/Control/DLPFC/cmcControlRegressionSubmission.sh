...
outputpath="/shared/CMC/metanetworksV2/Control/DLPFC/"
...
provenanceFile="/shared/CMC/metanetworksV2/Control/DLPFC/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Control/DLPFC/Regressionerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Control/DLPFC/Regressionout.txt"

#job script name
jobname="CMCDLPFCRegressionControl"
