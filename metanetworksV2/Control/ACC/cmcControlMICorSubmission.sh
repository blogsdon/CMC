...
provenanceFile="/shared/CMC/metanetworksV2/Control/DLPFC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Control/DLPFC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Control/DLPFC/MICorout.txt"

#job script name
jobname="CMCDLPFCMICorControl"
