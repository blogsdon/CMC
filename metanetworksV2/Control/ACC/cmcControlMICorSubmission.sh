...
provenanceFile="/shared/CMC/metanetworksV2/Control/ACC/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Control/ACC/MICorerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Control/ACC/MICorout.txt"

#job script name
jobname="CMCACCMICorControl"
