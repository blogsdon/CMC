...
outputpath="/shared/CMC/metanetworksV2/Control/ACC/"
...
provenanceFile="/shared/CMC/metanetworksV2/Control/ACC/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/CMC/metanetworksV2/Control/ACC/Regressionerror.txt"

#path to out output
outOutput="/shared/CMC/metanetworksV2/Control/ACC/Regressionout.txt"

#job script name
jobname="CMCACCRegressionControl"
